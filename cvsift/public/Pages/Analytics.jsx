...
export default function Analytics() {
  ...
  const loadAnalytics = async () => {
    ...
    try {
      ...
      console.log('Fetching CVs via Cloud Function');
      ...
      cvs.forEach(cv => {
        ...
        if (experiences.length === 0) {
          ...
          // Calculate total years of experience (earliest start to latest end)
          ...
          let totalYears = 0;
          // Calculate total years from earliest to latest
          if (earliestYear !== null && latestYear !== null) {
            totalYears = Math.max(0, latestYear - earliestYear);
          } else {
            // Fallback: estimate based on number of positions
            totalYears = experiences.length * 1.5;
          }
  ...
  const StatCard = ({ title, value, subtitle, icon: Icon, trend, color = "orange" }) => {
    ...
    return (
      <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200 hover:shadow-xl transition-all hover:-translate-y-1 group">
        ...
        <h3 className="text-4xl font-bold text-secondary-900 mb-2 font-heading">{value}</h3>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <Activity className="w-12 h-12 text-accent-500 animate-pulse mx-auto mb-4" />
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-secondary-900 font-heading">Analytics</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-secondary-900 flex items-center gap-2 font-heading">
            ...
            {analytics.dailyUploads.length > 0 && analytics.dailyUploads.some(d => d.uploads > 0) ? (
              ...
              <div className="h-64 flex items-center justify-center bg-gradient-to-br from-gray-50 to-accent-50 rounded-xl">
                <div className="text-center">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-accent-50 to-amber-50 rounded-xl p-5 border border-accent-100">
                <div className="flex justify-between mb-3">
                  <span className="text-sm font-bold text-secondary-900">Monthly Upload Limit</span>
                ...
                {(currentUser?.userData?.plan !== 'enterprise' && currentUser?.userData?.cvUploadLimit !== -1) && (
                  <div className="w-full bg-gray-200 rounded-full h-4 shadow-inner">
                    <div
                      className="bg-gradient-to-r from-accent-500 to-accent-600 h-4 rounded-full transition-all shadow-sm flex items-center justify-end pr-2"
                      style={{
              ...
              <div className="space-y-3">
                <h3 className="text-sm font-bold text-secondary-900 flex items-center gap-2 font-heading">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                    ...
                    <span className="text-sm font-bold text-secondary-900 px-3 py-1 bg-white rounded-lg shadow-sm">
                      {(analytics.uploadsThisMonth / new Date().getDate()).toFixed(1)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                    <span className="text-sm font-medium text-gray-700">Current plan</span>
                    <span className="text-sm font-bold text-accent-600 capitalize px-3 py-1 bg-accent-50 rounded-lg">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
          ...
          {analytics.recentActivity.length === 0 ? (
            <div className="text-center py-16 bg-gradient-to-br from-gray-50 to-accent-50 rounded-xl">
              <div className="w-20 h-20 bg-white rounded-2xl shadow-lg flex items-center justify-center mx-auto mb-4">
              ...
              <button
                ...
                className="bg-gradient-to-r from-accent-500 to-accent-600 hover:from-accent-600 hover:to-accent-700 text-white px-8 py-3 rounded-xl font-semibold transition-all shadow-lg shadow-accent-500/30 hover:shadow-xl hover:scale-105"
              >
                Upload CV
              </button>
            </div>
            ...
            <div className="space-y-3">
              {analytics.recentActivity.map((activity, index) => (
                <div
                  key={activity.id}
                  className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-50 to-accent-50/50 rounded-xl hover:from-gray-100 hover:to-accent-100/50 transition-all border border-gray-100 hover:border-accent-200 group"
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-secondary-900">{activity.action}</p>
        ...
        <div className="grid lg:grid-cols-2 gap-6 mt-8">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-secondary-900 flex items-center gap-2 font-heading">
                <div className="w-8 h-8 bg-dominant-500 rounded-lg flex items-center justify-center">
                ...
                {analytics.topSkills.map((skill, index) => (
                  <div key={index} className="group">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-semibold text-secondary-900">{skill.skill}</span>
                      <span className="text-sm font-bold text-dominant-600">{skill.count} CVs ({skill.percentage}%)</span>
                    </div>
            ...
            {analytics.topLocations.length > 0 ? (
              <div className="space-y-3">
                {analytics.topLocations.map((location, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-gradient-to-r from-gray-50 to-accent-50 rounded-xl hover:from-gray-100 hover:to-accent-100 transition-all border border-gray-100">
                    <span className="text-sm font-medium text-secondary-900">{location.location}</span>
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-bold text-accent-600 min-w-[60px] text-right">
              ...
              <div className="space-y-3">
                {analytics.educationDistribution.map((edu, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl hover:from-gray-100 hover:to-blue-100 transition-all border border-gray-100">
                    <span className="text-sm font-medium text-secondary-900">{edu.degree}</span>
                    <div className="flex items-center gap-3">
                      <div className="w-24 bg-gray-200 rounded-full h-2">
                        <div
              ...
              <div>
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-3xl font-bold text-dominant-600">{analytics.averageCompleteness}%</span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-4 shadow-inner">
                    <div
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-green-50 rounded-xl border border-green-200">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-secondary-900">Excellent (90%+)</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-blue-50 rounded-xl border border-blue-200">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-secondary-900">Good (70-89%)</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-xl border border-yellow-200">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-secondary-900">Fair (50-69%)</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-red-50 rounded-xl border border-red-200">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-secondary-900">Poor (&lt;50%)</span>
                  </div>
            ...
            {advancedLoading ? (
              ...
              <>
                ...
                {advancedAnalytics.timeToHire && (
                  <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
                    <div className="flex items-center justify-between mb-6">
                      <h3 className="text-xl font-bold text-secondary-900 flex items-center gap-2 font-heading">
                        <div className="w-8 h-8 bg-purple-500 rounded-lg flex items-center justify-center">
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
                      ...
                      {advancedAnalytics.funnel.stages && advancedAnalytics.funnel.stages.map((stage, index) => (
                        <div key={index} className="relative">
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-sm font-bold text-secondary-900 capitalize">{stage.status}</span>
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-8 shadow-inner overflow-hidden">
                            <div
                              className={`h-8 rounded-full transition-all flex items-center px-3 ${
                                ...
                                index === 2 ? 'bg-gradient-to-r from-accent-500 to-accent-600' :
                    ...
                    {advancedAnalytics.conversionRates && (
                      <div className="mt-6 pt-6 border-t border-gray-200">
                        <h4 className="text-sm font-bold text-secondary-900 mb-3 font-heading">Conversion Rates</h4>
                    ...
                    <div className="space-y-4">
                      {advancedAnalytics.sources.map((source, index) => (
                        <div key={index} className="p-4 bg-gradient-to-r from-gray-50 to-lime-50/50 rounded-xl border border-gray-100">
                          <div className="flex items-center justify-between mb-3">
                            <h4 className="font-bold text-secondary-900 font-heading">{source.source}</h4>
                            <div className="flex items-center gap-4">
                  ...
                  <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      {advancedAnalytics.diversity.genderDistribution && (
                        <div>
                          <h4 className="text-sm font-bold text-secondary-900 mb-3 font-heading">Gender Distribution</h4>
                      ...
                      {advancedAnalytics.diversity.ageDistribution && (
                        <div>
                          <h4 className="text-sm font-bold text-secondary-900 mb-3 font-heading">Age Distribution</h4>
                          <div className="space-y-2">
                      ...
                      {advancedAnalytics.insights.map((insight, index) => (
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              <p className="font-semibold text-secondary-900 mb-1">{insight.title}</p>
