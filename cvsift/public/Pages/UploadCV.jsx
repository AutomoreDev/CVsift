  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-dominant-50/30 to-secondary-50/30">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-secondary-900 font-heading">Upload CVs</h1>
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
                    ...
                    {(isAtLimit || isNearLimit) && (
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-gradient-to-r from-accent-500 to-accent-600 hover:from-accent-600 hover:to-accent-700 text-white rounded-lg font-semibold text-sm transition-all hover:scale-105 shadow-lg"
                        >
                          Upgrade Plan
                        </button>
                      </div>
          ...
          <div className="mb-6 bg-red-50 border border-red-200 rounded-2xl p-5 shadow-lg">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <h3 className="text-red-900 font-bold mb-2 flex items-center gap-2 font-heading">Upload Errors</h3>
        ...
        {/* Files List - Shown Above Drop Zone */}
        {files.length > 0 && (
          <div className="mb-8 bg-white rounded-2xl border-2 border-accent-300 overflow-hidden shadow-xl animate-in">
            <div className="px-6 py-5 bg-gradient-to-r from-accent-500 to-accent-600 border-b border-accent-400 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-white/20 backdrop-blur rounded-xl flex items-center justify-center shadow-md">
              ...
              {!uploading && files.some(f => f.status === 'pending') && (
                <button
                  ...
                  className="bg-white text-accent-600 hover:bg-accent-50 px-6 py-2.5 rounded-xl font-bold transition-all hover:scale-105 flex items-center gap-2 shadow-lg"
                >
                  <Upload size={18} />
            ...
            <div className="divide-y divide-gray-100">
              {files.map((fileObj, index) => (
                <div
                  key={fileObj.id}
                  className="px-6 py-5 flex items-center gap-4 hover:bg-gradient-to-r hover:from-gray-50 hover:to-accent-50/30 transition-all group"
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-bold text-secondary-900 truncate text-lg">
                      {fileObj.file.name}
                    </p>
                    ...
                    {fileObj.status === 'pending' && uploading && (
                      <div className="mt-3">
                        <div className="w-full bg-gray-200 rounded-full h-3 shadow-inner overflow-hidden">
                          <div
                            className="bg-gradient-to-r from-accent-500 to-accent-600 h-3 rounded-full transition-all shadow-sm flex items-center justify-end pr-2"
        ...
        <div
          className={`border-2 border-dashed rounded-2xl p-12 text-center transition-all shadow-lg ${
            isDragging
              ? 'border-accent-500 bg-gradient-to-br from-accent-50 to-accent-100 scale-105'
              : 'border-gray-300 bg-white hover:border-accent-400 hover:shadow-xl'
          }`}
        ...
        >
          ...
          <p className="text-gray-600 mb-8 text-lg">
            {extracting ? (
              <span className="flex items-center justify-center gap-2">
                ...
                <span className="font-semibold text-accent-600">Extracting ZIP file...</span>
              </span>
            ) : (
          ...
          <button
            ...
            className="bg-gradient-to-r from-accent-500 to-accent-600 hover:from-accent-600 hover:to-accent-700 text-white px-8 py-3 rounded-xl font-bold text-lg transition-all hover:scale-105 shadow-lg shadow-accent-500/30 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
          >
        ...
        {files.length > 0 && files.every(f => f.status === 'success') && (
          <div className="mt-8 bg-gradient-to-r from-green-50 to-green-100 border border-green-200 rounded-2xl p-6 shadow-xl">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-green-900 font-bold text-xl mb-2 font-heading">All files uploaded successfully!</h3>
