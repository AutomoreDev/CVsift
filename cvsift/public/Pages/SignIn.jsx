      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          {!showMfaVerification ? (
            <>
              <div className="mb-8">
                <h1 className="text-3xl font-bold text-secondary-900 mb-2 font-heading">Welcome Back</h1>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link to="/reset-password" className="text-sm text-accent-500 hover:text-accent-600 font-medium">
                  Forgot?
                </Link>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-12 py-3 border rounded-lg focus:ring-2 focus:ring-accent-500 focus:border-accent-500 outline-none transition-colors ${
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <a href="/signup" className="text-accent-500 font-semibold hover:text-accent-600">
                Sign Up
              </a>
            </p>
          </div>
              ...
              <div className="mb-8">
                <div className="flex items-center justify-center mb-4">
                  <div className="w-16 h-16 bg-accent-100 rounded-full flex items-center justify-center">
                    <Smartphone className="text-accent-500" size={32} />
                  </div>
                </div>
                <h1 className="text-3xl font-bold text-secondary-900 mb-2 text-center font-heading">Two-Factor Authentication</h1>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    placeholder="123456"
                    maxLength={6}
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-accent-500 focus:border-accent-500 outline-none text-center text-2xl tracking-widest"
                  />
                ...
                <button
                  ...
                  disabled={mfaLoading}
                  className="w-full text-gray-600 hover:text-secondary-900 py-3 font-medium transition-colors disabled:opacity-50"
                >
                  Back to Sign In
                </button>
              </div>
        ...
        <div className="text-center text-sm text-gray-500 mt-6 space-y-2">
          ...
          <div className="flex items-center justify-center space-x-4">
            <a href="/privacy-policy" className="hover:text-accent-500 transition-colors">Privacy Policy</a>
            <span>•</span>
            <a href="/terms-of-service" className="hover:text-accent-500 transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </div>
