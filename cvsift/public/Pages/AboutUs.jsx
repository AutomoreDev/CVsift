...
export default function AboutUs() {
  ...
  return (
    <div className="min-h-screen bg-white text-secondary-900">
      ...
      {/* Hero Section */}
      <section className="pt-24 lg:pt-32 pb-16 lg:pb-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-accent-50/30 via-white to-white">
        <div className="max-w-7xl mx-auto">
          <div className={`text-center max-w-4xl mx-auto transition-all duration-1000 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-accent-100 to-accent-50 text-accent-700 px-4 py-2 rounded-full mb-6 lg:mb-8 border border-accent-200/50">
              <Sparkles size={16} className="animate-pulse" />
              <span className="text-xs lg:text-sm font-semibold">Powered by Claude AI</span>
            </div>

            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-4 lg:mb-6 leading-tight font-heading">
              Screen <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-600 to-accent-500">Thousands</span> of CVs<br className="hidden sm:block" /> in{' '}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 lg:mb-16">
              <button
                ...
                className="w-full sm:w-auto bg-gradient-to-r from-accent-600 to-accent-500 hover:from-accent-700 hover:to-accent-600 text-white px-8 py-4 rounded-xl font-semibold text-base lg:text-lg transition-all hover:scale-105 flex items-center justify-center space-x-2 shadow-xl shadow-accent-500/30"
              >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8 mb-12 lg:mb-16">
              {stats.map((stat, idx) => (
                <div key={idx} className="text-center">
                  <div className="text-2xl lg:text-3xl font-bold text-secondary-900 mb-1">{stat.value}</div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl lg:rounded-3xl p-4 lg:p-8 shadow-2xl border border-gray-200/50">
                <div className="bg-white rounded-xl lg:rounded-2xl p-4 lg:p-6 shadow-inner">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="h-3 lg:h-4 bg-gradient-to-r from-accent-200 to-accent-100 rounded-full w-1/2 animate-pulse" style={{animationDelay: '150ms'}}></div>
                    ...
                    <div className="grid grid-cols-3 gap-3 lg:gap-4 mt-6">
                      <div className="h-20 lg:h-24 bg-gradient-to-br from-accent-100 to-accent-200 rounded-xl shadow-sm"></div>
              ...
              <div className="absolute -top-4 -right-4 w-24 h-24 bg-accent-400 rounded-full blur-3xl opacity-40 animate-pulse"></div>
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6 text-center font-heading">About CVSift</h2>
