  ...
  if (!hasAccess) {
    return (
      <div className="bg-orange-50 border border-orange-200 rounded-xl p-6 text-center">
        ...
        <h3 className="text-xl font-bold text-gray-900 mb-2">Custom Fields</h3>
    ...
    <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-end space-x-2">
                    ...
                    <button
                      ...
                      disabled={saving}
                      className="flex items-center space-x-2 px-4 py-2 bg-orange-500 text-white rounded-lg font-semibold hover:bg-orange-600 transition-colors disabled:opacity-50"
                    >
                      <Save size={16} />
                      <span>Save</span>
                    </button>
      ...
      {isAddingNew && (
        <div className="bg-orange-50 border border-orange-200 rounded-xl p-6 space-y-4">
          <div className="flex items-center justify-between mb-4">
            <h4 className="font-bold text-gray-900">Add New Custom Field</h4>
            <button
              onClick={() => {
                setIsAddingNew(false);
                setNewField({ name: '', label: '', type: 'text', required: false, options: [], conditionalOn: null, conditionalValue: null });
            ...
            <div className="grid grid-cols-5 gap-2">
              {FIELD_TYPES.map((type) => {
                ...
                return (
                  ...
                  >
                    <Icon size={20} className={newField.type === type.value ? 'text-orange-500 mx-auto' : 'text-gray-400 mx-auto'} />
                    <p className={`text-xs font-medium mt-1 ${newField.type === type.value ? 'text-orange-600' : 'text-gray-600'}`}>
                      {type.label}
                    </p>
                  </button>
                );
          ...
          <div className="flex justify-end space-x-2 pt-4 border-t border-orange-200">
            ...
            <button
              ...
              disabled={saving}
              className="flex items-center space-x-2 px-6 py-2 bg-orange-500 text-white rounded-lg font-semibold hover:bg-orange-600 transition-colors disabled:opacity-50"
            >
              <Plus size={18} />
              <span>Add Field</span>
            </button>
