...
- Separate certificate pages (full-page documents with logos, signatures, ` +
  `dates)
- Online course completion certificates (Udemy, Coursera, edX, LinkedIn Learning)
- Portfolio pages, project samples, or reference letters

CRITICAL: This is a MULTI-PAGE PDF. You MUST scan EVERY SINGLE PAGE from ` +
  `start to finish. Certificate documents typically appear on pages AFTER ` +
  `the main CV (pages 2, 3, 4, 5, etc.). DO NOT STOP after reading the first page.

Look for these certificate indicators on ALL pages:
- Certificate titles in large/bold fonts (e.g., "iOS & Swift Bootcamp", ` +
  `"Xero advisor certified", "Certificate of Attendance")
- Platform logos and names: Udemy, Coursera, edX, Xero, Payspace, etc.
- Instructor names: "Dr. Angela Yu", "Angela Yu", "Instructor: [Name]"
- Completion dates: "Date: June 11, 2025", "Certification date:", "October 29, 2024"
- Certificate IDs, reference numbers, expiry dates
- Official signatures, stamps, or authentication marks
- Duration indicators: "60.5 total hours", "Length:", etc.

EXAMPLE CERTIFICATES TO LOOK FOR:
- "iOS & Swift - The Complete iOS App Development Bootcamp" (Udemy)
- "Xero advisor certified" (Xero)
- "Certificate of Attendance" (Payspace)
- "JavaScript and Income Base Formulas" course certificates
...
JSON Structure (return exactly this format):
{
  ...
  "github": "GitHub profile URL (if present, otherwise null)",
  "portfolio": "Personal website/portfolio URL (if present, otherwise null)",
...
- github: Extract GitHub profile URL if present
  * Look for: "github.com/...", "GitHub:", social media links, developer profiles
  * Accept formats: "https://github.com/username", "github.com/username", "@username"
  * If found, normalize to full URL: "https://github.com/username"
  * If not found, return null
- portfolio: Extract personal website/portfolio URL if present
  * Look for: "Website:", "Portfolio:", "Personal Site:", any standalone URLs
  * Accept any valid URL format (e.g., "https://example.com", "www.example.com", "example.com")
  * Common patterns: portfolio sites, personal domains, Behance, Dribbble profiles
  * If found, normalize to full URL with https:// prefix
  * If not found, return null
...
- Examples of certifications to look for:
  ...
  * Industry: "Professional Engineer", "Licensed Electrician", ` +
  `"Real Estate License"
  * Online Learning: "Udemy Certificate", "Coursera Certificate", ` +
  `"edX Certificate", "LinkedIn Learning", "Pluralsight"
  * Developer Bootcamps: "iOS Development", "Web Development Bootcamp", ` +
  `"Full Stack Development", "Data Science Bootcamp"
  * Specific Course Certificates: Extract course title, instructor name, ` +
  `completion date, platform (e.g., "iOS & Swift Bootcamp by Dr. Angela Yu on Udemy")
...
- If certificate appears as a full-page document, extract ALL visible ` +
  `details
- For online courses, format as: name: "Course Title", issuer: "Platform ` +
  `(Instructor)", year: "Completion Year"
  * Example: {"name": "iOS & Swift - Complete iOS App Development", ` +
  `"issuer": "Udemy (Dr. Angela Yu)", "year": "2025", "id": null}
