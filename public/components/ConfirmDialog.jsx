    ...
    switch (type) {
      ...
      default:
        return {
          ...
          button: 'from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 shadow-orange-500/30',
  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl animate-slideUp">
        {/* Header */}
        <div className={`p-6 border-b ${colors.border} bg-gradient-to-r from-gray-50 to-orange-50/20`}>
