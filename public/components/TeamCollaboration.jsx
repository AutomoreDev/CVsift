...
export default function TeamCollaboration() {
  ...
  const getRoleIcon = (role) => {
    switch (role) {
      case 'owner': return <Crown size={16} className="text-orange-500" />;
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="bg-white border border-orange-200 rounded-lg p-4 mb-4">
              <p className="text-sm font-semibold text-orange-900 mb-2">Available on:</p>
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-lg font-semibold hover:from-orange-600 hover:to-orange-700 transition-all shadow-lg hover:shadow-xl hover:scale-105"
            >
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-100 to-amber-100 text-orange-700 rounded-full text-sm font-semibold border border-orange-200">
          <Users size={16} />
        ...
        <div className="flex border-b-2 border-gray-200">
          <button
            ...
            className={`flex-1 px-6 py-4 text-sm font-bold transition-all relative ${
              activeSubTab === 'invite'
                ? 'text-orange-500 border-b-2 border-orange-500 bg-orange-50 -mb-0.5'
              ...
              {isTeamMember && (
                <div className="bg-purple-50 border-2 border-purple-200 rounded-xl p-6 shadow-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="font-bold text-purple-900">Team Member View</h4>
              ...
              {!isTeamMember && (
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-6 shadow-sm">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900">Invite Team Member</h4>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-orange-50/20">
        ...
        <div className="divide-y divide-gray-100">
          ...
          <div className="px-6 py-4 flex items-center justify-between bg-orange-50/30">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full flex items-center justify-center text-white font-bold shadow-md">
                {isTeamMember
          ...
          {teamMembers.map((member) => (
            <div key={member.id} className="px-6 py-4 flex items-center justify-between hover:bg-gray-50 transition-colors">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-gray-900">{member.displayName || 'Team Member'}</p>
