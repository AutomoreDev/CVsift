              ...
              <table className="w-full">
                    ...
                    {pricingPlans.map((plan) => (
                      <th key={plan.id} className="px-6 py-4 text-center">
                        <div className="flex flex-col items-center">
                          <span className={`text-sm font-bold ${plan.popular ? 'text-orange-500' : 'text-gray-900'}`}>
                            {plan.name}
                          </span>
                          {plan.price !== null ? (
                ...
                <tbody className="divide-y divide-gray-100">
                  ...
                  <tr>
                    ...
                    <td className="px-6 py-4 text-center text-sm font-medium text-orange-600">Unlimited</td>
                  </tr>
                  <tr>
