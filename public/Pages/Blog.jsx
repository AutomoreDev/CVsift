      ...
      {selectedPost ? (
        ...
        <article className="py-12 lg:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            {/* Post Header */}
            <div className="mb-8">
              <div className="inline-flex items-center space-x-2 bg-orange-100 text-orange-700 px-3 py-1 rounded-full mb-4">
                <span className="text-sm font-semibold">{selectedPost.category}</span>
              </div>
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 leading-tight">{selectedPost.title}</h1>
            ...
            <div className="mt-12 bg-gradient-to-r from-orange-50 to-orange-100 rounded-2xl p-8 border border-orange-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Ready to Transform Your Hiring Process?</h3>
              ...
              <button
                ...
                className="bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-700 hover:to-orange-600 text-white px-8 py-3 rounded-lg font-semibold transition-all hover:scale-105 flex items-center space-x-2"
              >
        ...
        <>
          {/* Hero Section */}
          <section className="pt-16 lg:pt-24 pb-12 lg:pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-orange-50/30 to-white">
            <div className="max-w-7xl mx-auto text-center">
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-orange-100 to-orange-50 text-orange-700 px-4 py-2 rounded-full mb-6 border border-orange-200/50">
                <TrendingUp size={16} />
                <span className="text-sm font-semibold">CVSift Blog</span>
              </div>
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Recruitment <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-orange-500">Insights</span> & Tips
              </h1>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                {blogPosts.map((post) => (
                  ...
                  >
                    {post.featured && (
                      <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-4 py-2 text-sm font-semibold">
                        Featured Post
                      </div>
                    )}
                    <div className="p-6">
          ...
          {/* CTA Section */}
          <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 text-white">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl lg:text-4xl font-bold mb-4">Start Screening CVs Smarter Today</h2>
              <p className="text-lg mb-8 opacity-90">
                Join hundreds of companies using AI-powered CV screening to hire faster and better.
              </p>
              <button
                onClick={() => navigate('/signup')}
                className="bg-white text-orange-600 px-8 py-4 rounded-xl font-semibold text-lg hover:scale-105 transition-all shadow-xl"
              >
                Try CVSift Free
              </button>
            </div>
