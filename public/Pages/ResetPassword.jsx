          ...
          {!success ? (
            <>
              ...
              <div className="mt-6 text-center">
                <a
                  href="/signin"
                  className="inline-flex items-center text-sm text-gray-600 hover:text-orange-500 font-medium transition-colors"
                >
            ...
            <div className="text-center">
              ...
              <div className="space-y-3">
                <a
                  href="/signin"
                  className="block w-full bg-orange-500 hover:bg-orange-600 text-white py-3 rounded-lg font-semibold transition-all hover:scale-[1.02]"
                >
                  Back to Sign In
                </a>
                <button
                  ...
                  className="block w-full text-orange-500 hover:text-orange-600 py-2 font-medium transition-colors"
                >
                  Send Another Link
                </button>
              </div>
