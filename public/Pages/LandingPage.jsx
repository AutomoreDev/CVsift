...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden text-gray-900 bg-white">
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            <div className="flex items-center space-x-3">
              <div className="flex items-center space-x-3 cursor-pointer" onClick={() => window.scrollTo(0, 0)}>
                <div className="flex items-center justify-center shadow-lg w-9 h-9 lg:w-10 lg:h-10 bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 rounded-xl">
                  <span className="text-lg font-bold text-white lg:text-xl">CV</span>
                </div>
                <span className="text-xl font-bold text-transparent lg:text-2xl bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text">Sift</span>
              </div>
            ...
            <div className="items-center hidden space-x-8 lg:flex">
              <a href="#features" className="text-sm font-medium text-gray-600 transition-colors hover:text-orange-600">Features</a>
              <a href="#how-it-works" className="text-sm font-medium text-gray-600 transition-colors hover:text-orange-600">How It Works</a>
              <a href="#pricing" className="text-sm font-medium text-gray-600 transition-colors hover:text-orange-600">Pricing</a>
              <a href="#testimonials" className="text-sm font-medium text-gray-600 transition-colors hover:text-orange-600">Testimonials</a>
            </div>

            <div className="flex items-center space-x-3 lg:space-x-4">
              <button 
                onClick={() => navigate('/signin')}
                className="hidden text-sm font-medium text-gray-700 transition-colors sm:block hover:text-orange-600 lg:text-base"
              >
                Sign In
              </button>
              <button 
              ...
              <button 
                ...
                className="p-2 text-gray-600 lg:hidden hover:text-orange-600"
              >
        ...
        {mobileMenuOpen && (
          <div className="bg-white border-t border-gray-100 shadow-lg lg:hidden">
            <div className="px-4 py-4 space-y-3">
              <a href="#features" className="block py-2 font-medium text-gray-600 hover:text-orange-600" onClick={() => setMobileMenuOpen(false)}>Features</a>
              <a href="#how-it-works" className="block py-2 font-medium text-gray-600 hover:text-orange-600" onClick={() => setMobileMenuOpen(false)}>How It Works</a>
              <a href="#pricing" className="block py-2 font-medium text-gray-600 hover:text-orange-600" onClick={() => setMobileMenuOpen(false)}>Pricing</a>
              <a href="#testimonials" className="block py-2 font-medium text-gray-600 hover:text-orange-600" onClick={() => setMobileMenuOpen(false)}>Testimonials</a>
              <button 
                onClick={() => navigate('/signin')}
                className="block w-full py-2 font-medium text-left text-gray-700 hover:text-orange-600"
              >
                Sign In
              </button>
            </div>
      ...
      {/* Hero Section */}
      <section className="px-4 pt-24 pb-16 lg:pt-32 lg:pb-24 sm:px-6 lg:px-8 bg-gradient-to-b from-orange-50/30 via-white to-white">
        <div className="mx-auto max-w-7xl">
          <div className={`text-center max-w-4xl mx-auto transition-all duration-1000 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="inline-flex items-center px-4 py-2 mb-6 space-x-2 text-orange-700 border rounded-full bg-gradient-to-r from-orange-100 to-orange-50 lg:mb-8 border-orange-200/50">
              <Sparkles size={16} className="animate-pulse" />
              <span className="text-xs font-semibold lg:text-sm">Powered by Claude AI</span>
            </div>
            
            <h1 className="mb-4 text-4xl font-bold leading-tight sm:text-5xl lg:text-7xl lg:mb-6">
            ...
            <div className="flex flex-col items-center justify-center gap-4 mb-12 sm:flex-row lg:mb-16">
              <button
                onClick={() => navigate('/signup')}
                className="flex items-center justify-center w-full px-8 py-4 space-x-2 text-base font-semibold text-white transition-all shadow-xl sm:w-auto bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-700 hover:to-orange-600 rounded-xl lg:text-lg hover:scale-105 shadow-orange-500/30"
              >
            ...
            <div className="relative">
              <div className="p-4 border shadow-2xl bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl lg:rounded-3xl lg:p-8 border-gray-200/50">
                <div className="p-4 bg-white shadow-inner rounded-xl lg:rounded-2xl lg:p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="w-1/2 h-3 rounded-full lg:h-4 bg-gradient-to-r from-orange-200 to-orange-100 animate-pulse" style={{animationDelay: '150ms'}}></div>
                    ...
                    <div className="grid grid-cols-3 gap-3 mt-6 lg:gap-4">
                      <div className="h-20 shadow-sm lg:h-24 bg-gradient-to-br from-orange-100 to-orange-200 rounded-xl"></div>
              ...
              <div className="absolute w-24 h-24 bg-orange-400 rounded-full -top-4 -right-4 blur-3xl opacity-40 animate-pulse"></div>
              <div className="absolute w-24 h-24 bg-purple-400 rounded-full -bottom-4 -left-4 blur-3xl opacity-40 animate-pulse" style={{animationDelay: '1s'}}></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-16 lg:py-24 bg-gradient-to-b from-white to-gray-50">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="mb-12 text-center lg:mb-16">
            <div className="inline-flex items-center px-4 py-2 mb-4 space-x-2 text-orange-700 bg-orange-100 rounded-full">
              <Star size={16} />
              <span className="text-sm font-semibold">Powerful Features</span>
            </div>
            <h2 className="mb-4 text-3xl font-bold lg:text-5xl lg:mb-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 lg:gap-8">
            {features.map((feature, idx) => (
              <div key={idx} className="p-6 transition-all duration-300 bg-white border border-gray-100 shadow-sm group lg:p-8 rounded-2xl hover:shadow-2xl hover:-translate-y-2 hover:border-orange-200">
                <div className="flex items-center justify-center w-12 h-12 mb-4 transition-transform duration-300 shadow-sm lg:w-14 lg:h-14 bg-gradient-to-br from-orange-100 to-orange-50 rounded-xl lg:mb-6 group-hover:scale-110">
                  <feature.icon className="text-orange-600" size={24} />
                </div>
                <h3 className="mb-2 text-lg font-bold text-gray-900 lg:text-xl lg:mb-3">{feature.title}</h3>
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="mb-12 text-center lg:mb-16">
            ...
            {completedSteps.length > 0 && (
              <button
                onClick={resetDemo}
                className="text-sm font-semibold text-orange-600 underline hover:text-orange-700"
              >
                Reset Demo
              </button>
            )}
          ...
          {uploadedFiles.length === 0 && (
            <div className="flex justify-center mb-8 lg:mb-12">
              <div
                ...
                className="p-6 transition-all duration-300 border-2 border-orange-300 shadow-xl cursor-move bg-gradient-to-br from-orange-100 to-orange-200 lg:p-8 rounded-2xl hover:scale-110 animate-pulse"
              >
                <Folder size={48} className="mx-auto mb-2 text-orange-600" />
                <p className="text-sm font-bold text-center text-orange-700">CVs Folder</p>
                <p className="mt-1 text-xs text-center text-orange-600">Drag me to Step 1!</p>
              </div>
            </div>
          )}
            ...
            >
              <div className={`bg-gradient-to-br from-orange-50 to-orange-100 p-6 lg:p-8 rounded-2xl border-2 relative overflow-hidden h-full ${
                ...
                <div className="relative z-10">
                  ...
                  <div className="mb-4">
                    <span className="px-3 py-1 text-xs font-bold text-orange-600 bg-orange-200 rounded-full lg:text-sm">Step 1</span>
                  </div>
                  <h3 className="mb-2 text-xl font-bold text-gray-900 lg:text-2xl lg:mb-3">Upload CVs</h3>
                  ...
                  {!isProcessing && uploadedFiles.length === 0 ? (
                    ...
                    <div className="mt-6 space-y-2">
                      {uploadedFiles.map((file, index) => (
                        ...
                        >
                          <FileText size={14} className="flex-shrink-0 text-orange-500" />
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
            {pricingTiers.filter(t => t.name !== 'Enterprise').map((tier, idx) => (
              <div key={idx} className={`relative bg-white rounded-xl p-6 border transition-all hover:shadow-xl ${
                ...
                {tier.popular && (
                  <div className="absolute px-3 py-1 text-xs font-bold text-white bg-orange-500 rounded-full -top-3 left-6">
                    MOST POPULAR
                  </div>
                )}
                ...
                <div className="mb-6 text-center">
                  <h3 className="mb-3 text-xl font-bold text-gray-900">{tier.name}</h3>
                  <div className="mb-4">
                  ...
                  <div className="inline-block px-4 py-1.5 bg-orange-50 border border-orange-200 rounded-full">
          ...
          <div className="mt-8 text-center lg:mt-12">
            <p className="text-sm text-gray-600 lg:text-base">
              Need help choosing a plan? <button onClick={() => navigate('/signup')} className="font-semibold text-orange-600 hover:underline">Get started</button> or <a href="mailto:sales@cvsift.com" className="font-semibold text-orange-600 hover:underline">contact sales</a>
            </p>
          </div>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="relative py-16 overflow-hidden text-white lg:py-24 bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700">
        ...
        <div className="relative z-10 max-w-4xl px-4 mx-auto text-center sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-center">
            <button
              onClick={() => navigate('/signup')}
              className="px-8 py-4 text-base font-semibold text-orange-600 transition-all bg-white shadow-2xl rounded-xl lg:text-lg hover:scale-105 hover:shadow-white/50"
            >
              Start Free
            </button>
          </div>
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-8 mb-8 md:grid-cols-4 lg:gap-12 lg:mb-12">
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center mb-4 space-x-2">
                <div className="flex items-center justify-center w-8 h-8 rounded-lg shadow-lg bg-gradient-to-br from-orange-500 to-orange-600">
              ...
              <p className="mb-2 text-xs text-gray-500">
                Support: <a href="mailto:emma@automore.co.za" className="font-semibold text-orange-500 transition-colors hover:text-orange-400">emma@automore.co.za</a>
              </p>
              ...
              <div className="flex space-x-3">
                <a href="#" className="flex items-center justify-center w-8 h-8 transition-colors bg-gray-800 rounded-lg hover:bg-orange-600">
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm">
                <li><a href="#features" className="transition-colors hover:text-orange-500">Features</a></li>
                <li><a href="#pricing" className="transition-colors hover:text-orange-500">Pricing</a></li>
                <li><a href="#how-it-works" className="transition-colors hover:text-orange-500">How It Works</a></li>
                <li><a href="#testimonials" className="transition-colors hover:text-orange-500">Testimonials</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm">
                <li><a href="/about" className="transition-colors hover:text-orange-500">About Us</a></li>
                <li><a href="/blog" className="transition-colors hover:text-orange-500">Blog</a></li>
                <li><a href="/contact" className="transition-colors hover:text-orange-500">Contact</a></li>
                <li><a href="https://www.automore.co.za" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-orange-500">About Automore</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm">
                <li><a href="/privacy-policy" className="transition-colors hover:text-orange-500">Privacy Policy</a></li>
                <li><a href="/terms-of-service" className="transition-colors hover:text-orange-500">Terms of Service</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-between pt-8 border-t border-gray-800 md:flex-row">
            ...
            <div className="flex items-center space-x-6 text-sm">
              <a href="/privacy-policy" className="transition-colors hover:text-orange-500">Privacy Policy</a>
              <a href="/terms-of-service" className="transition-colors hover:text-orange-500">Terms of Service</a>
              <a href="https://www.automore.co.za" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-orange-500">About Automore</a>
            </div>
          </div>
        </div>
      </footer>
