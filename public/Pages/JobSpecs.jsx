...
function CustomSelect({ value, onChange, options, placeholder = 'Select...', className = '' }) {
  ...
  return (
    <div ref={dropdownRef} className={`relative ${className}`} style={{ zIndex: isOpen ? 1000 : 'auto' }}>
      ...
      >
        <span className={`text-sm ${!value || value === '' || value === 'any' ? 'text-gray-500' : 'text-gray-900 font-medium'}`}>
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Job Specifications</h1>
          ...
          <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl animate-slideUp">
            ...
            <div className="p-6">
              ...
              <ul className="space-y-3 mb-6">
                ...
                <li className="flex items-start gap-3 text-sm text-gray-700 bg-gradient-to-r from-orange-50 to-orange-100/50 rounded-xl p-3">
                  <div className="w-6 h-6 bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Check className="text-white" size={14} />
                  </div>
            ...
            <div className="p-6 bg-gray-50 rounded-b-2xl">
              <button
                ...
                className="w-full py-3.5 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-xl font-bold transition-all hover:scale-105 shadow-lg shadow-orange-500/30"
              >
                Upgrade Now
              </button>
            </div>
              ...
              {jobSpecs.map((spec, index) => (
                ...
                >
                  ...
                  <div className="space-y-3 mb-6">
                    {spec.location && (
                      <div className="flex items-center gap-3 text-sm text-gray-700 bg-gradient-to-r from-gray-50 to-orange-50/30 rounded-lg p-2.5">
                    ...
                    {spec.requiredSkills && spec.requiredSkills.length > 0 && (
                      <div className="flex items-start gap-3 text-sm text-gray-700 bg-gradient-to-r from-gray-50 to-orange-50/30 rounded-lg p-2.5">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-8">
              ...
              <div className={`border border-gray-200 rounded-lg ${expandedSections.basic ? 'overflow-visible' : 'overflow-hidden'}`}>
                ...
                {expandedSections.basic && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all placeholder-gray-400 hover:border-gray-300"
                ...
                <div className="mt-5">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={4}
                    className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all placeholder-gray-400 hover:border-gray-300 resize-none"
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      <h3 className="text-lg font-bold text-gray-900">Demographic Preferences</h3>
              ...
              <div className="flex gap-4 pt-2">
                ...
                <button
                  type="submit"
                  className="flex-1 px-6 py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl hover:from-orange-600 hover:to-orange-700 transition-all font-semibold shadow-lg shadow-orange-500/30 hover:shadow-xl hover:scale-[1.02]"
                >
