  ...
  return (
    <div ref={dropdownRef} className={`relative ${className}`} style={{ zIndex: isOpen ? 1000 : 'auto' }}>
      <button
        ...
        className="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg flex items-center justify-between hover:border-orange-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors"
      >
        ...
        <div className="absolute z-[1001] w-full mt-2 bg-white border border-gray-200 rounded-lg shadow-xl max-h-60 overflow-auto">
          {options.map((option) => (
            <button
              ...
              className={`w-full px-4 py-2.5 text-left text-sm hover:bg-orange-50 transition-colors flex items-center justify-between ${
                value === option.value ? 'bg-orange-50 text-orange-600 font-medium' : 'text-gray-700'
              }`}
            >
              <span>{option.label}</span>
              {value === option.value && <Check size={16} className="text-orange-600" />}
            </button>
          ))}
        </div>
      )}
  ...
  const fetchCVs = async () => {
    try {
      ...
      if (teamAccess?.isTeamMember && teamAccess?.teamOwnerId) {
        console.log('Fetching team CVs via Cloud Function for owner:', teamAccess.teamOwnerId);
        ...
        if (result.data.success) {
          ...
          console.log('Team CVs fetched:', cvsData.length);
          setCvs(cvsData);
        ...
        console.log('Fetching own CVs for user:', currentUser.uid);
  ...
  const applyFilters = () => {
    ...
    if (filters.skills) {
      ...
      filtered = filtered.filter(cv => {
        ...
        if (!hasSkills) return false; // Exclude CVs without skills when filtering by skills
    ...
    if (filters.experienceYears !== 'all') {
      filtered = filtered.filter(cv => {
        ...
        let totalYears = 0;
        cv.metadata.experience.forEach(exp => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-orange-50/30 to-purple-50/30">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">CV Library</h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
            ...
            <div>
              ...
              {userData?.teamAccess?.isTeamMember && (
                <div className="mt-2 flex items-center gap-2 text-sm">
                  ...
                  <span className="text-orange-100 text-xs">Viewing team owner's CVs</span>
                </div>
              )}
            </div>
            <button
        ...
        <button
          onClick={() => navigate('/upload')}
          className="lg:hidden w-full mb-6 flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl font-bold transition-all hover:scale-105 shadow-lg shadow-orange-500/30"
        >
          <Upload size={20} />
          Upload CVs
        </button>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-6 shadow-lg">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              <div className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg flex items-center justify-center shadow-md">
              ...
              <input
                ...
                className="w-full pl-16 pr-4 py-3.5 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none font-medium transition-all"
              />
            </div>
              ...
              <div className="flex items-center gap-4 flex-wrap">
                ...
                <div className="flex-1 min-w-[280px]">
                  {matchingInProgress ? (
                    ...
                    <CustomSelect
                      ...
                      options={[
                        { value: '', label: 'No job spec selected' },
                        ...jobSpecs.map(spec => ({
                          value: spec.id,
                ...
                {jobSpecs.length === 0 && canCreateJobSpecs(userData?.plan) && (
                  <button
                    ...
                    className="text-sm text-orange-500 hover:text-orange-600 font-medium whitespace-nowrap flex items-center gap-1"
                  >
                    Create Job Spec →
                  </button>
                )}
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 hover:border-orange-400 outline-none transition-colors text-sm"
                    />
                  </div>
                ...
                {expandedSections.professional && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 hover:border-orange-400 outline-none transition-colors text-sm placeholder-gray-400"
                    />
                  </div>
        ...
        {selectedCvs.length > 0 && (
          <div className="bg-gradient-to-r from-orange-50 to-orange-100 border-2 border-orange-200 rounded-2xl p-6 mb-6 flex items-center justify-between shadow-lg">
            <div className="flex items-center gap-3">
        ...
        {!loading && cvs.length > 0 && filteredCvs.length === 0 && (
          <div className="bg-white rounded-2xl border border-gray-200 p-12 text-center shadow-lg">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">No CVs found</h3>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white rounded-xl font-bold text-lg transition-all hover:scale-105 shadow-lg shadow-orange-500/30"
            >
              <X size={20} />
              Clear all filters
            </button>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-lg">
            ...
            <div
              ...
              style={{
                height: '8px',
                scrollbarWidth: 'thin',
                scrollbarColor: '#ff6d38 transparent'
              }}
              onScroll={(e) => {
                if (tableContainerRef.current) {
            ...
            >
              ...
              <thead className="bg-gradient-to-r from-gray-50 to-orange-50/30 border-b-2 border-gray-100">
                <tr>
                  <th className="sticky left-0 z-20 bg-gradient-to-r from-gray-50 to-orange-50/30 px-6 py-4 text-left border-r border-gray-200">
                    <input
                      type="checkbox"
                      checked={selectedCvs.length === filteredCvs.length}
                      onChange={handleSelectAll}
                      className="w-5 h-5 text-orange-500 rounded-lg focus:ring-orange-500 focus:ring-2"
                    />
                  </th>
                  <th className="sticky left-[72px] z-20 bg-gradient-to-r from-gray-50 to-orange-50/30 px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider border-r border-gray-200 min-w-[280px]">
                    File Name
                  </th>
                  ...
                  <th className="sticky right-0 z-20 bg-gradient-to-r from-gray-50 to-orange-50/30 px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider border-l border-gray-200 min-w-[140px]">
                    Actions
                  </th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100">
                {filteredCvs.map((cv) => (
                  <tr key={cv.id} className="hover:bg-gradient-to-r hover:from-gray-50 hover:to-orange-50/30 transition-all group">
                    <td className="sticky left-0 z-10 bg-white group-hover:bg-gradient-to-r group-hover:from-gray-50 group-hover:to-orange-50/30 px-6 py-4 border-r border-gray-100">
                      <input
                        type="checkbox"
                    ...
                    <td className="sticky left-[72px] z-10 bg-white group-hover:bg-gradient-to-r group-hover:from-gray-50 group-hover:to-orange-50/30 px-6 py-4 border-r border-gray-100">
                    ...
                    <td className="sticky right-0 z-10 bg-white group-hover:bg-gradient-to-r group-hover:from-gray-50 group-hover:to-orange-50/30 px-6 py-4 border-l border-gray-100">
                      <div className="flex items-center space-x-2">
                        <button
